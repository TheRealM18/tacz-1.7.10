    ...
    public static void handle(ClientMessageCraft message, Supplier<NetworkEvent.Context> contextSupplier) {
        ...
        if (context.getDirection().getReceptionSide().isServer()) {
            context.enqueueWork(() -> {
                ...
                if (entity.containerMenu.containerId == message.menuId && entity.containerMenu instanceof GunSmithTableMenu) {
                    GunSmithTableMenu menu = (GunSmithTableMenu) entity.containerMenu;
