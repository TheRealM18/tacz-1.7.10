...
public final class HitboxHelper {
    ...
    public static AABB getFixedBoundingBox(Entity entity, Entity owner) {
        ...
        if (OtherConfig.SERVER_HITBOX_LATENCY_FIX.get() && entity instanceof ServerPlayer && owner instanceof ServerPlayer) {
        ...
        // 应用蹲伏导致的 hitbox 变形
        double expandHeight = entity instanceof Player && !((Player) entity).isCrouching() ? 0.0625 : 0.0;
